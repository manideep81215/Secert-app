...
function StatsBar() {
  ...
  const stats = [
    ...
    { label: 'Days In Love',      value: getElapsed(LOVE_START).totalDays.toLocaleString(),  icon: '??', color: '#ff6b9d' },
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .os-footer-quote{font-family:'Playfair Display',serif;font-style:italic;font-size:1rem;color:rgba(255,180,200,.28);line-height:1.6}
